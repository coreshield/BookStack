...
return [
    ...
    'reg_email_confirmation' => '电子邮件确认',
    'reg_email_confirmation_toggle' => '新用户注册时，需要电子邮件确认',
    'reg_confirm_email_desc' => '如果启用域名限制功能，则自动开启电子邮件确认，并且本项设定将被忽略。',
    ...
    'users_external_auth_id_desc' => '该ID用于使用外部认证系统时匹配用户身份。',
